...
```shell
go run github.com/robermar23/langchaingo/examples/openai-completion-example@main
```
...
Here is the entire program (from [ollama-chat-example](https://github.com/robermar23/langchaingo/blob/main/examples/ollama-chat-example/ollama_chat_example.go)).
