...
import (
	...
	"github.com/robermar23/langchaingo/llms/googleai/vertex"
...
func testMultiContentImageLink(t *testing.T, llm llms.Model) {
	...
	parts := []llms.ContentPart{
		llms.ImageURLPart("https://github.com/robermar23/langchaingo/blob/main/docs/static/img/parrot-icon.png?raw=true"),
